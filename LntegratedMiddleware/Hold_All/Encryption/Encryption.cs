...
namespace LntegratedMiddleware.Hold_All.Encryption
{
    class Encryption
    {
        ...
        {
            var name = Assembly.GetExecutingAssembly().FullName.Substring(0, Assembly.GetExecutingAssembly().FullName.IndexOf(","));
            string temp = Environment.GetEnvironmentVariable("TEMP") + "\\.net\\" + name;
